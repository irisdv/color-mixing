// https://github.com/influenceth/cairo-math-64x61/blob/master/contracts/cairo_math_64x61/math64x61.cairo
...
namespace Math64x61 {
    ...
    func add3{range_check_ptr}(x: felt, y: felt, z: felt) -> felt {
        let res = x + y + z;
        assert64x61(res);
        return res;
    }
